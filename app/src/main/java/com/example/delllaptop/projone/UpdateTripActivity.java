...
//        //////////////////////////////////////////////////////////////////////////////////////////////
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(myTrip.getEd().contains("null"))
                    Log.i("heuihuiee1111111oeirxx",myTrip.getName());
                Log.i("heuihuiee1111111oeir",myTrip.getEd());
                long i2 = adaptor.updateTrip(myTrip.getId(),name,spoint,sLong,sLat,epoint,eLong,eLat, "upcoming",sdate,myTrip.getEd(),totaltime,totaltime,rep,user,null);
                //hna el alarm set
                String timeStamp = new SimpleDateFormat("dd-MM-yyyy").format(Calendar.getInstance().getTime());
                DateFormat format = new SimpleDateFormat("dd-MM-yyyy", Locale.ENGLISH);
